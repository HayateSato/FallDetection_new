...
MODEL_CONFIGS: Dict[ModelName, ModelConfig] = {
    ModelName.V0: ModelConfig(
        ...
        inference_class="ml_pipeline.data_processing_registry.PipelineSelector",
    ...
    ModelName.V1: ModelConfig(
        ...
        inference_class="ml_pipeline.models.v1_inference.ModelV1Inference",
        uses_barometer=True,
        acc_preprocessing="v1_features",
    ...
    ModelName.V2: ModelConfig(
        ...
        inference_class="ml_pipeline.models.v2_inference.ModelV2Inference",
        uses_barometer=True,
    ...
    ModelName.V3: ModelConfig(
        ...
        inference_class="ml_pipeline.models.v3_inference.ModelV3Inference",
        uses_barometer=True,
        acc_preprocessing="v1_features",
        baro_preprocessing="v2_paper",
        num_features=20,
    ...
    ModelName.V4: ModelConfig(
        ...
        inference_class="ml_pipeline.models.v4_inference.ModelV4Inference",
        uses_barometer=True,
        acc_preprocessing="v2_paper",
        baro_preprocessing="v1_ema",
        num_features=12,
